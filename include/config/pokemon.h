...
#define P_GEN5_STATIC_BATTLERS          TRUE        // Enables optional 96x96 static Gen 5-style front/back battlers in battle. Existing 64x64 species graphics remain the fallback.
